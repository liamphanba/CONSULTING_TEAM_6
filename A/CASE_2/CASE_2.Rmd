...
Boxplot <- ggplot(Aanaesthetics_Pivoted) +
 ...
 geom_boxplot() + scale_fill_manual(values=c("#294C60", "#648767", "#7776BC","#967D69")) + labs(title = "Boxplots", subtitle = "Aanesthetics", caption = "©2023 Alpine Insights") +  theme_minimal() + theme(plot.title = element_text(face = "bold"))
...
Histograms <- Aanaesthetics_Pivoted %>% ggplot( aes(x=Time, fill=Anaesthetic)) + geom_histogram( color="#e9ecef", alpha=1, position = 'identity', binwidth = 1) + scale_fill_manual(values=c("#294C60", "#648767", "#7776BC","#967D69")) + theme_minimal() + labs(fill="") + facet_wrap(~Anaesthetic) + theme(plot.title = element_text(face = "bold")) + labs(title = "Histograms", subtitle = "Aanesthetics", caption = "©2023 Alpine Insights")
