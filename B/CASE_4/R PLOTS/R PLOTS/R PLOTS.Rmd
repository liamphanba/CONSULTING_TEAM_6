...
ggplot(teaching) +
 ...
 scale_fill_manual(values = c(Male = "#0D8387", 
Female = "#2F4F4E")) +
 labs(y = "Post-Score", title = "Teaching Data", subtitle = "Post-Score According to Preferences and Gender", 
 caption = "@2023 Alpine Insights") +
 theme_minimal()+ xlab("") 
...
Experiment = "#2F4F4E")) +
 labs(y = "Post-Score", title = "Data Teaching", subtitle = "Post-Score according to Session and Group", 
 caption = "@2023 Alpine Insights") +
 theme_minimal() +
