...
# CHOOSING WHICH RESAMPLING METHOD
print(summarytools::dfSummary(df), method = 'render')
print(summarytools::dfSummary(df_ROSE), method = 'render')
print(summarytools::dfSummary(df_BOTH), method = 'render')
...
Best with ROSE and BOTH sampling
...
library(caret)
nn1 <- train(churn ~ ., data = df, method = "nnet")
