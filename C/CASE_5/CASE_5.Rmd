...
PRED_PRUNED_TREE <- predicted.pruned_tree
PRED_BAGGING <- predicted
PRED_KNN <- predicted.knn
PRED_QDA <- predicted.qda
PRED_QLOG <- predicted.log
PRED_GAUSSIAN_SVM <- predicted.svm


ENSEMBLES <- cbind(PRED_BOOSTING,PRED_PRUNED_TREE,PRED_BAGGING,PRED_KNN,PRED_QDA)
...
roc_score.svm =roc(factor(dftest$churn, ordered=TRUE), factor(ENSEMBLES$MAJORITY_VOTE, ordered=TRUE))
plot(roc_score.svm ,main ="ROC curve")
